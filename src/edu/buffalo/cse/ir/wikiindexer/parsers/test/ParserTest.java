 ...
 * 
 */
package src.edu.buffalo.cse.ir.wikiindexer.parsers.test;
...
import src.edu.buffalo.cse.ir.wikiindexer.test.PropertiesBasedTest;
...
public class ParserTest extends PropertiesBasedTest {
	...
	/**
	 * Test method for {@link src.edu.buffalo.cse.ir.wikiindexer.parsers.Parser#parse(java.lang.String, java.util.Collection)}.
	 * @throws SAXException 
	 * @throws IOException 
	 */
	@Test
	public final void testParse() throws SAXException, IOException {
		...
		//five documents
		testClass.parse(FileUtil.getRootFilesFolder(idxProps) + "five_entries.xml", list);     //WikiDump_1600.xml
